...
/**
 * Http协议解析管道,只注册，但是不处理
 * @author baolong
 *
 */
public class HttpProtocolRegisterPipe extends BSRPipe{
...
//					BSRHttpServletResponse response2 = BSRHttpServletResponseParser.createSendRedirectResponse(301, "Moved Permanently", null, "http://www.baidu.com");
					 ...
					 * 在诸多请求都准备好之后，执行下一步管道
					 */
					doNext(bsrEvents,bsrHttpServletRequest,bsrHttpServletResponse,bsrContext);
					
					/**设置响应报文，在HttpProtocolRegisterPipe中只注册，而不写出*/
					/**
